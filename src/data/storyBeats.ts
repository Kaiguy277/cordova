...
export interface StoryBeat {
  type: 'walk' | 'dialogue';
  phaseIndex: number;
  /** Which phase the metrics/graphs should show. Defaults to phaseIndex if omitted. 
   *  Set to previous phase so dialogue happens BEFORE the graph updates. */
  metricsPhaseIndex?: number;
  npc?: NPCType;
  speaker?: string;
  text?: string;
}
...
export const storyBeats: StoryBeat[] = [
  ...
  // ── Phase 1: Power Creek (2002) — dialogue shows diesel-era metrics, then walk updates ──
  { type: 'walk', phaseIndex: 1, metricsPhaseIndex: 0 },
  {
    type: 'dialogue', phaseIndex: 1, metricsPhaseIndex: 0, npc: 'cec-worker',
    speaker: 'CEC Lineman',
    text: "Power Creek's online! Six megawatts of hydro from the Eyak Lake watershed. Biggest thing to happen to Cordova's grid.",
  },
  {
    type: 'dialogue', phaseIndex: 1, metricsPhaseIndex: 0, npc: 'fisherman',
    speaker: 'Fish Processor',
  ...
  { type: 'walk', phaseIndex: 2, metricsPhaseIndex: 1 },
  {
    type: 'dialogue', phaseIndex: 2, metricsPhaseIndex: 1, npc: 'engineer',
  ...
  {
    type: 'dialogue', phaseIndex: 2, metricsPhaseIndex: 1, npc: 'cec-worker',
    speaker: 'CEC Lineman',
  ...
  { type: 'walk', phaseIndex: 3, metricsPhaseIndex: 2 },
  {
    type: 'dialogue', phaseIndex: 3, metricsPhaseIndex: 2, npc: 'cec-worker',
    speaker: 'CEC Lineman',
  ...
  {
    type: 'dialogue', phaseIndex: 3, metricsPhaseIndex: 2, npc: 'fisherman',
    speaker: 'Fish Processor',
  ...
  {
    type: 'dialogue', phaseIndex: 3, metricsPhaseIndex: 2, npc: 'board-member',
  ...
  { type: 'walk', phaseIndex: 4, metricsPhaseIndex: 3 },
  {
    type: 'dialogue', phaseIndex: 4, metricsPhaseIndex: 3, npc: 'tech-worker',
  ...
  {
    type: 'dialogue', phaseIndex: 4, metricsPhaseIndex: 3, npc: 'cec-worker',
    speaker: 'CEC Lineman',
  ...
  {
    type: 'dialogue', phaseIndex: 4, metricsPhaseIndex: 3, npc: 'fisherman',
    speaker: 'Fish Processor',
  ...
  {
    type: 'dialogue', phaseIndex: 4, metricsPhaseIndex: 3, npc: 'board-member',
    speaker: 'CEC Board Member',
  ...
  { type: 'walk', phaseIndex: 5, metricsPhaseIndex: 4 },
  {
    type: 'dialogue', phaseIndex: 5, metricsPhaseIndex: 4, npc: 'board-member',
    speaker: 'CEC Board Member',
  ...
  {
    type: 'dialogue', phaseIndex: 5, metricsPhaseIndex: 4, npc: 'fisherman',
    speaker: 'Fish Processor',
  ...
  { type: 'walk', phaseIndex: 6, metricsPhaseIndex: 5 },
  {
    type: 'dialogue', phaseIndex: 6, metricsPhaseIndex: 5, npc: 'engineer',
    speaker: 'Project Engineer',
  ...
  // ── Phase 7: Future (2028+) ──
  { type: 'walk', phaseIndex: 7, metricsPhaseIndex: 6 },
  {
    type: 'dialogue', phaseIndex: 7, metricsPhaseIndex: 6, npc: 'cec-worker',
    speaker: 'CEC Lineman',
    text: "A storage reservoir at Humpback could get us to ninety-five percent renewable — even through winter processing season.",
  },
  {
    type: 'dialogue', phaseIndex: 7, metricsPhaseIndex: 6, npc: 'fisherman',
    speaker: 'Fish Processor',
